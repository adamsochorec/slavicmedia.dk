        ...
        <arcticle class="wrapper standard">
            ...
            <section>
                <h2 class="v1">Coding skills<h2>
                        ...
                        <p>PHP<svg id="coding-languages-php" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <p>JavaScript<svg id="coding-languages-javascript" xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 78.56 88.92">
                                <path class="javascript-4" fill="#e6a329"
                                    d="M78.56,0H0L7.36,79.87l31.91,9.05,31.91-9.05L78.56,0Z" />
                                <path class="javascript-2" fill="#f1bf22"
                                    d="M39.28,6.51V82.15l25.86-7.32L71.42,6.51H39.28Z" />
                                <path class="javascript-3" fill="#fff"
                                ...
                                <path class="javascript-1" fill="#ebebeb"
                        ...
                        <p>Python<svg id="coding-languages-python" data-name="Layer 1"
                                ...
                                <defs>
                                    <linearGradient id="linear-gradient" x1="-237.96" y1="472.37" x2="-237.3"
                                        y2="471.71" gradientTransform="translate(19719.11 39220.39) scale(82.82 -83.01)"
                                        gradientUnits="userSpaceOnUse">
                                        <stop offset="0" stop-color="#387eb8" />
                                        <stop offset="1" stop-color="#366994" />
                                    </linearGradient>
                                    <linearGradient id="linear-gradient-2" x1="-237.9" y1="472.28" x2="-237.19"
                                        y2="471.61" gradientTransform="translate(19747.44 39248.51) scale(82.82 -83.01)"
                                        gradientUnits="userSpaceOnUse">
                                        <stop offset="0" stop-color="#ffe052" />
                                        <stop offset="1" stop-color="#ffc331" />
                                    </linearGradient>
                                </defs>
                                <path class="python-1" fill="url(#linear-gradient)"
                                ...
                                <path class="python-2" fill="url(#linear-gradient-2)"
