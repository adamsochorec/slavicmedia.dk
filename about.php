        ...
        <arcticle class="wrapper standard">
            ...
            <section>
                <h2 class="v1">Coding skills<h2>
                        <br>
                        <p><svg id="coding-languages" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
                                <path
                        ...
                        <p><svg id="coding-languages" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                <path
                        ...
                        <p><svg id="coding-languages" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
                                <path
                        ...
                        <p><svg id="coding-languages" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                                <path
                        ...
                        <p><svg id="coding-languages" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="48"
                                height="48"
