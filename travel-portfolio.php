...
<html lang="en">
  <head>
    ...
    <title>Travel Portfolio | Slavic Media</title>
  </head>
  <body id="travel-portfolio">
    ...
    <main>
          ...
          <div class="grid-item">
            ...
            <div class="pathname-container">
              <p>
                ...
                <span class="pathname"
                  ><a href="/portfolio"><?php echo $lang['asset_102'] ?></a>
                  &#8250;</span
                >
                <span class="pathname"><?php echo $lang['asset_88'] ?></span>
              </p>
            </div>
          </div>
          <div class="grid-item">
      ...
      <article class="wrapper-wide">
        ...
        <div class="grid-container fifty-fifty">
          <div class="grid-item">
            <h3 class="highlited reveal">December 2022</h3>
            <h2 class="reveal">
              <?php echo $lang['asset_95'] ?>
            </h2>
          </div>
          <div class="grid-item">
            <p class="reveal">
              <?php echo $lang['asset_96'] ?>
            </p>
          </div>
        </div>
      </article>
        ...
        <div class="grid-container fifty-fifty">
          <div class="grid-item">
            <h3 class="highlited reveal">
              <?php echo $lang['asset_97'] ?>
            </h3>
            <h2 class="reveal">
              <?php echo $lang['asset_98'] ?>
            </h2>
          </div>
          <div class="grid-item">
            <p class="reveal">
              <?php echo $lang['asset_99'] ?>
            </p>
          </div>
        </div>
      </article>
