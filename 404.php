...
<body id="Error">
    <header>
        <nav class="nav-bar">
            ...
            <a aria-describedby="works" class="navbar-style" id="nav-logo" href="https://adamsochorec.dk/works">
                <span class="logo">adam sochorec</span>
            </a>
            <ul class="nav-menu">
                <!-- NAVIGATION BAR LINKS START -->
                <li class="nav-item">
                    <a aria-describedby="works" class="navbar-style" href="https://adamsochorec.dk/works">works</a>
                </li>
                <li class="nav-item">
                    <a aria-describedby="about" class="navbar-style" href="https://adamsochorec.dk/about">about</a>
                </li>
