...
<html lang="en">
  <head>
    <meta name="description" content="Daytrip to the westernmost point of
    Denmark, Blåvand strand and visiting Blåvand's lighthouse.” />
    <meta
      name="keywords"
      content="Blåvand, blavand, huk, strand, jutland, jylland, peninsula, oksbol, oksbøl, adam, sochorec, @adamsochorec, adamsochorec, adamsochorec.com, BIG, Bjarke, Ingels, group, tirpitz, museum, WWII, world, war two, history, atlantic, wall, polycam, 3D, model, models, scanning, scan, app, north, sea, daytrip, Denmark, Danmark, travel, traveling, cestování, adventure, bunker, bunkers, bunkr, bunkry, danish, military, dansk, westernmost, seashore, shore, west, AR, augumented, reality, dobrodružství, severní, moře, nordic, nordics, scandinavia, severské, země, státy, skandinávie, dánsko, Canon, EOS, 6D, lens, photography, fotografie, cestopis, cestopisy, blog, fotky, lightroom, english, nature, countryside, příroda, pláž, landscape, art, beton, concrete, sand, dunes, desert, písek, duny, duna, pustina, DSB, syddanmark, baltic, baltské, skagen, border, lighthouse, star wars, scarif, surreal"
    />
    ...
    <main>
      <article class="wrapper-standard">
        ...
        <p class="reveal">
          ...
          started walking. Town's city centre isn't the largest, and soon you
          ...
          dunes usually built a few meters from the sea.<br />
        </p>
        <br />
        ...
        <p class="reveal">
          ...
          and on the north, in Skagen, flows into the Baltic sea. Blåvandstrand,
          the westernmost point of Denmark, was filled with the sounds of waves
          blended with the screaming of seagulls and kids playing with old WWII
          bunkers, built during WWII as a part of the Atlantic Wall. I soon
          figure out that the bunkers are <i>standing</i> every few hundred
          meters, probably along the entire west shore. But
          <i>standing</i> isn't probably the right term. After more than a half
          of century without any maintenance in the sand right by the sea was
        ...
        <p class="reveal">
          ...
          climbing up on the roof, hiding in the interior and former machine gun
          nests, I realize the point. WWII bunkers were built with the purpose
          to make killing people more efficient, with fewer losses, are now toys
          and playgrounds! The wraith spirit is gone, devaluated, and replaced
        ...
        <section>
          ...
          <div class="sketchfab-embed-wrapper reveal">
            <iframe
              ...
              execution-while-not-rendered
              web-share
              src="https://sketchfab.com/models/37e4150677634273954aa6e69434ec15/embed?autospin=1&dnt=1"
              ><p class="alt-alt">
                3D scan of an Atlantic Wall bunker from WWII.
              </p>
            </iframe>
        ...
        <p class="reveal">
          ...
          surreal, the surrounding landscape looks like the planet Scarif,
        ...
        <p class="reveal">
          ...
          of those down on the beach.<br /><br />
          As I observe later when wandering along the west shore, the Danish
          Royal military likes to train in local stratified terrain and the
          surrounding of Blåvand is not an exception. The beach and sand fields
          towards the north-east accommodate several watchtowers (you can
          observe those on the left bottom corner of the panorama photo) and
          other facilities serving military purposes, such as antennas, small
          repositories, yellow signs announcing military areas as well as
          several other various models of bunkers.<br /><br />Blåvand lighthouse
          is reachable by car, with the possibility to park nearby the sight. I
          would also recommend visiting nearby Bjarke Ingels's
          <a
          ...
          <ol>
            <li class="reveal">
              <a
                ...
                href="https://en.wikipedia.org/wiki/Jutland#World_War_II"
                >Jutland during WWII
              </a>
            </li>
            <li class="reveal">
              <a
                target="_blank"
                rel="noopener noreferrer"
                href="https://en.wikipedia.org/wiki/Blåvandshuk"
            ...
            <li class="reveal">
              <a
                target="_blank"
                rel="noopener noreferrer"
                href="https://en.wikipedia.org/wiki/Tirpitz_Museum_(Denmark)"
