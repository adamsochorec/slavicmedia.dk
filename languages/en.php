...
$lang = [
    ...
    "expeditiondenmark_title" => "Expedition Denmark",
    "expeditiondenmark_desc" => "Join our cycle journey from the very south to the very north of Denmark.",
    "contact" => "CONTACT",
    "subject" => "Subject",
    "company" => "Company",
    "fullName" => "Full Name",
    ...
    "marcel-title" => "Partner & Videographer",
    ...
    "adam-title" => "Partner & Photographer",
    ...
    "brandingguide_title" => "Branding Guide",
    "brandingguide_desc" => " A branding guide sets the visual and stylistic standards for a company's brand, ensuring consistency in logos, colors, fonts, and design.",
    "creditguide_title" => "Credit Guide",
    "creditguide_desc" => "A credit guide outlines how to tag and give credit to Slavic Media on social media and for our work.",
    "presskit_title" => "Press Kit",
    "presskit_desc" => "A press kit is a package of promotional materials provided to the media to introduce a company or individual, including press releases, images, and relevant information.",
    "download" => "Download",
    "preview" => "Preview",
    "press" => "PRESS"
];
