...
<html lang="en">
  <head>
    ...
    ?>
    <title>Privacy&nbsp;Policy | Slavic Media</title>
  </head>
  <body id="privacy">
    <!-- HEADER START -->
    <?php
    ...
    <main>
      <article class="wrapper-wide">
        ...
        <span class="date reveal"
          ><p class="reveal">Last Modified: December 2023</p></span
        >
        <hr class="reveal" role="separator" />
        <section>
          <h2 class="highlited">Introduction</h2>
          <p class="reveal">
            Slavic Media I/S, ("Company" or "we", "us", or "our") respect your
            privacy and are committed to protecting the privacy of our website
            visitors, customers, business partners and end users, through our
            compliance with this policy.<br /><br />This policy describes the
          ...
          <ol>
            ...
            <ul>
              <li class="reveal">
                <span class="highlited">Cookies (or browser cookies)</span>. A
