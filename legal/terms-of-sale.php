...
<html lang="en">
  ...
  ?>
    <title>Terms of Sale | Slavic Media</title>
  </head>
  <body id="legal">
    <!-- HEADER START -->
    <?php
        ...
        <ol>
          <li class="reveal">
            <p>
              ...
              Lightroom presets, courses) are as listed on Slavic Media’s
              website. Prices are subject to change without prior notice.
            </p>
          </li>
          <li class="reveal">
            <p>
              <u>Payment</u>: Payment is due at the time of purchase via the
              accepted payment methods specified on our website. Transactions
              must be completed before access to digital products is granted.
            </p>
          </li>

          <li class="reveal">
            <p>
              <u>Refunds</u>:Refunds are issued only in the event of
              non-delivery of the purchased digital product. Customers must
              report the non-delivery within 7 days of the expected delivery
