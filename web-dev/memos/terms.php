...
<body>
    ...
    <main>
        <div class="wrapper">
            ...
            <br>
            <p>These terms and conditions outline the rules and regulations for the use of Memos's Website, located at
                <a href="memos">memos.dk</a>.
            </p>
            <br>
            <p>By accessing this website, we assume you accept these terms and conditions. Do not continue to use Memos
                if you do not agree to take all of the terms and conditions stated on this page.</p>
            <br><br>
            <h3>Cookies:</h3>
            <br>
            <p>The website uses cookies to help personalize your online experience. By accessing Memos, you agreed to
                use the required cookies.</p>
            <br>
            <p>A cookie is a text file that is placed on your hard disk by a web page server. Cookies cannot be used to
            ...
            <br>
            <p>We may use cookies to collect, store, and track information for statistical or marketing purposes to
                operate our website. You have the ability to accept or decline optional Cookies. There are some required
                Cookies that are necessary for the operation of our website. These cookies do not require your consent
                as they always work. Please keep in mind that by accepting required Cookies, you also accept third-party
                Cookies, which might be used via third-party provided services if you use such services on our website,
                for example, a video display window provided by third parties and integrated into our website.</p>
            <br><br>
            <h4>License:</h4>
            <br>
            <p>Unless otherwise stated, Memos and/or its licensors own the intellectual property rights for all material
                on Memos. All intellectual property rights are reserved. You may access this from Memos for your own
                personal use subjected to restrictions set in these terms and conditions.</p>
            <p>You must not:</p>
            <br>
            <ul>
                <li>Copy or republish material from Memos</li>
                <br>
                <li>Sell, rent, or sub-license material from Memos</li>
                <br>
                <li>Reproduce, duplicate or copy material from Memos</li>
                <br>
                <li>Redistribute content from Memos</li>
                <br><br>
            </ul>
            <p>This Agreement shall begin on the date hereof.</p>
            <br>
            <p>Parts of this website offer users an opportunity to post and exchange opinions and information in certain
                areas of the website. Memos does not filter, edit, publish or review Comments before their presence on
                the website. Comments do not reflect the views and opinions of Memos, its agents, and/or affiliates.
                Comments reflect the views and opinions of the person who posts their views and opinions. To the extent
                permitted by applicable laws, Memos shall not be liable for the Comments or any liability, damages, or
            ...
            <br>
            <p>Memos reserves the right to monitor all Comments and remove any Comments that can be considered
            ...
            <p>You hereby grant Memos a non-exclusive license to use, reproduce, edit and authorize others to use,
            ...
            <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us
                ...
                absence of Memos; and (d) the link is in the context of general resource information.</p>
            <br>
            ...
            <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our
                website, you must inform us by sending an e-mail to Memos. Please include your name, your organization
            ...
            <ul>
                ...
                <br>
                <li>Using any other description of our Website being linked to that makes sense within the context and
                    format of content on the linking party's site.</li>
            </ul>
            <br>
            <p>No use of Memos's logo or other artwork will be allowed for linking absent a trademark license agreement.
            </p>
            <br><br>
            <h3>Content Liability:</h3>
            <br>
            <p>We shall not be held responsible for any content that appears on your Website. You agree to protect and
                defend us against all claims that are raised on your Website. No link(s) should appear on any Website
