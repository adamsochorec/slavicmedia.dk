    ...
    <main>
      <div class="wrapper">
        ...
        <p>
          ...
          use of /memos/homepage's Website, located at
          <a href="/memos.php">memos.dk</a>.
        </p>
        <br />
        <p>
          By accessing this website, we assume you accept these terms and
          conditions. Do not continue to use Memos if you do not agree to take
        ...
        <p>
          ...
          By accessing Memos, you agreed to use the required cookies.
        </p>
        <br />
        <p>
        ...
        <br />
        <p>
          Unless otherwise stated, Memos and/or its licensors own the
          intellectual property rights for all material on Memos. All
          intellectual property rights are reserved. You may access this from
          Memos for your own personal use subjected to restrictions set in these
        ...
        <p>
          ...
          opinions and information in certain areas of the website. Memos does
          not filter, edit, publish or review Comments before their presence on
          the website. Comments do not reflect the views and opinions of Memos,
          ...
          permitted by applicable laws, Memos shall not be liable for the
        ...
        <br />
        <p>
          Memos reserves the right to monitor all Comments and remove any
        ...
        <p>
          You hereby grant Memos a non-exclusive license to use, reproduce, edit
        ...
        <p>
          ...
          the hyperlink compensates the absence of Memos; and (d) the link is in
        ...
        <p>
          ...
          sending an e-mail to Memos. Please include your name, your
        ...
        <br />
        <p>
          No use of Memos's logo or other artwork will be allowed for linking
