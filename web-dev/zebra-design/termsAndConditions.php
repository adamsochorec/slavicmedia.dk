...
<head>
    ...
    <meta
        name="description"
        content="These terms and conditions outline the rules and regulations for the use of Memos’s Website, located at zebradesign.dk" />
    <meta
        name="keywords"
    ...
    <title>Zebra Design | Terms and Conditions</title>
</head>
...
<body>
    ...
    <main>
        <div class="termsAndConditionsInfo">
            <h1>Terms and Conditions</h1>
            <p>
                These terms and conditions outline the rules and regulations for the
                use of Zebra Design's Website, located at
                <a href="zebra-design">zebradesign.dk</a>.
            </p>
            <p>
                By accessing this website, we assume you accept these terms and
                conditions. Do not continue to use Zebra Design if you do not agree to
                take all of the terms and conditions stated on this page.
            </p>
            <h2>Cookies:</h2>
            <p>
                The website uses cookies to help personalize your online experience.
                By accessing Zebra Design, you agreed to use the required cookies.
            </p>
            <p>
            ...
            <h2>License:</h2>
            <p>
                Unless otherwise stated, Zebra Design and/or its licensors own the
                intellectual property rights for all material on Zebra Design. All
                intellectual property rights are reserved. You may access this from
                Zebra Design for your own personal use subjected to restrictions set
                in these terms and conditions.
            </p>
            <p>You must not:</p>
            <ul>
                <li>Copy or republish material from Zebra Design</li>
                <li>Sell, rent, or sub-license material from Zebra Design</li>
                <li>Reproduce, duplicate or copy material from Zebra Design</li>
                <li>Redistribute content from Zebra Design</li>
            </ul>
            <p>This Agreement shall begin on the date hereof.</p>
            <p>
                Parts of this website offer users an opportunity to post and exchange
                opinions and information in certain areas of the website. Zebra Design
                does not filter, edit, publish or review Comments before their
                presence on the website. Comments do not reflect the views and
                opinions of Zebra Design, its agents, and/or affiliates. Comments
                reflect the views and opinions of the person who posts their views and
                opinions. To the extent permitted by applicable laws, Zebra Design
                shall not be liable for the Comments or any liability, damages, or
                expenses caused and/or suffered as a result of any use of and/or
                posting of and/or appearance of the Comments on this website.
            </p>
            <p>
                Zebra Design reserves the right to monitor all Comments and remove any
            ...
            <p>
                You hereby grant Zebra Design a non-exclusive license to use,
            ...
            <p>
                ...
                the hyperlink compensates the absence of Zebra Design; and (d) the
            ...
            <p>
                ...
                sending an e-mail to Zebra Design. Please include your name, your
            ...
            <p>
                No use of Zebra Design's logo or other artwork will be allowed for
